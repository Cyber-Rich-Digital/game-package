...
CREATE INDEX `idx_group_id` ON `Admin_group_permissions` (`group_id`);

CREATE INDEX `idx_permission_id` ON `Admin_group_permissions` (`permission_id`);

CREATE INDEX `idx_created_at` ON `Admin_group_permissions` (`created_at`);

CREATE INDEX `idx_deleted_at` ON `Admin_group_permissions` (`deleted_at`);
